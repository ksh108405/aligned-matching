...
VOC_NETWORK_SIZE = 512
VOC_MIN_MAX_SIZE = get_min_max_size(VOC_NETWORK_SIZE, conv4_3_size['0.07'])
VOC_HALF_SIZED = False

TT100K_NETWORK_SIZE = 1024
TT100K_MIN_MAX_SIZE = get_min_max_size(TT100K_NETWORK_SIZE, conv4_3_size['0.1'])
TT100K_HALF_SIZED = False

COCO_NETWORK_SIZE = 300
COCO_MIN_MAX_SIZE = get_min_max_size(COCO_NETWORK_SIZE, conv4_3_size['0.1'])
